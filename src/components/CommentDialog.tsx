...
function CommentDialog({ meetingId }: { meetingId: Id<"meetings"> }) {
  ...
  const existingComments = useQuery(api.comments.getComments, { meetingId });
  ...
  return (
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      ...
      <DialogContent className="sm:max-w-[600px]">
        <DialogHeader>
          <DialogTitle>Meeting Comments</DialogTitle>
        </DialogHeader>
